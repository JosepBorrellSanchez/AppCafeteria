...
public class Productesfiltrats extends ActionBarActivity{
	...
	private static String url = "http://josepborrellweb.esy.es/gestio/index.php/Productes/jsoncat/";
	//JSON Node Names 
	...
	private class JSONParse extends AsyncTask<String, String, JSONObject> {
       ...
       protected void onPreExecute() {
           ...
           pDialog = new ProgressDialog(Productesfiltrats.this);
       ...
       protected JSONObject doInBackground(String... args) {
        ...
        protected void onPostExecute(JSONObject json) {
   		 ...
   		 try {
   				...
   				url = "http://josepborrellweb.esy.es/gestio/index.php/Productes/jsoncat/";

   				ListAdapter adapter = new SimpleAdapter(Productesfiltrats.this, oslist,
